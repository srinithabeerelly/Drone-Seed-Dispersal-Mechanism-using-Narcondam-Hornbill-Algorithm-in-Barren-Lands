...
\begin{figure*}[h!]
\centering
    \subfigure[\scriptsize Seed variety concerning sandy loam]{
    \label{de}
    \includegraphics[scale=0.35]{plot12.png}
 }
    \subfigure[\scriptsize Seed variety concerning loam]{
    \label{df}
    \includegraphics[scale=0.35]{plot13.png}
}
    \subfigure[\scriptsize Seed variety concerning clay loam]{
     \label{dt}
...
\begin{figure*}[h!]
\centering
    \subfigure[\scriptsize Accuracy comparison]{
    \label{dac}
    \includegraphics[scale=0.5]{plot15.png}
 }
    \subfigure[\scriptsize Precision comparison]{
    \label{dpr}
    \includegraphics[scale=0.5]{plot16.png}
 }
...
% \begin{figure}[htp]
%     \centering
%     \includegraphics[scale=0.6]{plot16.png}
...
\bibitem{11} Chavhan, S., Kumar, S., Tiwari, P., Liang, X., Lee, I.H. and Muhammad, K., 2023. Edge-enabled Blockchain-based V2X Scheme for Secure Communication within the Smart City Development. IEEE Internet of Things Journal.
...
\bibitem{10} Prabhakaran, P., Chavhan, S., Kumar, M. and Rodrigues, J.J., 2023, June. ML-based Minimization of AoI in a Vehicular Communication Network. In 2023 8th International Conference on Smart and Sustainable Technologies (SpliTech) (pp. 1-6). IEEE.
...
\bibitem{12} Dhinesh Kumar R, Chavhan, S., Gupta, D., Khanna, A. and Rodrigues, J.J., 2021. An intelligent self-learning drone assistance approach towards V2V communication in smart city. In DroneCom@ MobiCom (pp. 19-24).
